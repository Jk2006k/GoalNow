...
export default function BehavioralInterview() {
  ...
  const questionSpeechLabel = (() => {
    ...
    if (isQuestionSpeechPlaying) return "Interviewer is reading the question."
      ...
      <div className="bdy">
        ...
        <div className="ctr">
          <div className="qcn">
            ...
            <div className="mca">
              <div
                className={`mrng ${isMicActive ? 'active' : isRecordingBlocked ? 'blocked' : 'idle'}`}
              ...
              <div className={`mst ${isMicActive ? 'rec' : ''}`}>
                {isMicActive
                  ...
                  : isRecordingBlocked
                    ? 'Wait for the question audio to finish'
                    : 'Click to begin recording'}
              </div>

              <div className="abts">
                {!isMicActive && !hasStopped && (
                  <button className="bnxt" onClick={handleMicToggle} disabled={isRecordingBlocked}>
                    Start Recording
                  </button>
                )}
                {isMicActive && (
