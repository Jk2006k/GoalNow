export const technicalInterviewStyles = `
...
.cambox{width:100%;aspect-ratio:3/4;background:#111;border-radius:12px;overflow:hidden;position:relative;border:3px solid #e0e0e0;transition:border-color .08s ease;}
.cambox video{width:100%;height:100%;object-fit:cover;display:block;transform:scaleX(-1);}

.cambox.alarm-red{border-color:#ff1111 !important;animation:alm-red .42s ease-in-out infinite;}
.cambox.alarm-orange{border-color:#ff6600 !important;animation:alm-orange .42s ease-in-out infinite;}

@keyframes alm-red{0%,100%{box-shadow:0 0 0 2px rgba(255,17,17,.4),0 0 12px rgba(255,17,17,.65),0 0 28px rgba(255,17,17,.3),inset 0 0 12px rgba(255,17,17,.2);}50%{box-shadow:0 0 0 6px rgba(255,17,17,.75),0 0 28px rgba(255,17,17,1),0 0 52px rgba(255,17,17,.55),inset 0 0 26px rgba(255,17,17,.5);}}
@keyframes alm-orange{0%,100%{box-shadow:0 0 0 2px rgba(255,102,0,.4),0 0 12px rgba(255,102,0,.65),0 0 28px rgba(255,102,0,.3),inset 0 0 12px rgba(255,102,0,.2);}50%{box-shadow:0 0 0 6px rgba(255,102,0,.75),0 0 28px rgba(255,102,0,1),0 0 52px rgba(255,102,0,.55),inset 0 0 26px rgba(255,102,0,.5);}}

.abar{position:absolute;bottom:0;left:0;right:0;padding:8px 10px;font-size:.67rem;font-weight:700;letter-spacing:.05em;text-align:center;text-transform:uppercase;border-radius:0 0 10px 10px;z-index:20;line-height:1.3;animation:brin .15s ease-out;}
