...
const allEnabled = camEnabled && screenEnabled && fullEnabled
...
<div className="assessment-wrapper">
  ...
  <div className="left-panel">
    <div className="assessment-title">Take an Assessment</div>
    <div className="assessment-card">
      <div className="assessment-name">Behavioural Interview | Practice Assessment</div>
      <div className="assessment-info"><span>Proctoring</span><strong>Online</strong></div>
      <div className="assessment-info"><span>Duration</span><strong>15-30 min</strong></div>
      <div className="assessment-info"><span>Total Questions</span><strong>10</strong></div>
    </div>
  </div>
  ...
  <div className="right-panel">
    ...
    <div className="page-header">
      <div className="permission-title">System Check</div>
      <div className="permission-desc">Complete all checks below before you begin the interview.</div>
    </div>
    ...
    <div className="pre-note">
      ...
      <div className="pre-note-text">
        ...
        <span className="pre-note-body">
          Ensure you are in a quiet, well-lit space with a stable internet connection. Once the interview starts, do not switch tabs or exit fullscreen — this will auto-submit your session. Have your thoughts ready; there are no retakes.
        </span>
      </div>
    </div>
